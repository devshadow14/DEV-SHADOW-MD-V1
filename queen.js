...
const port = por.PORT;
const ownerNumber = ["221767833987"];
if (!app) return;
// Session directory
...
async function connectToWA() {
  ...
  //===========================
  console.log("🔥 DEV SHADOW MD is starting...");
  ...
  conn.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      let up = `
          🚀 **© 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 𝚌𝚘𝚗𝚗𝚎𝚌𝚝𝚎 𝚊𝚟𝚎𝚌 𝚜𝚞𝚌𝚌𝚎𝚜!** ✅ 
          
          --- **🎉 Welcome to © 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 𝚅1 💚!** 🎉 
          ...
          --- Thank you for using **© 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 𝚅1 💚**. 
          Bot whatsapp bien analysé et sécurisé. 
          connecté sans risque ni spam merci a votre confiance. 
      ...
      conn.sendMessage(conn.user.id, {
        text: up,
        contextInfo: {
          mentionedJid: ["221767833987@s.whatsapp.net"], // specify mentioned JID(s) if any
          groupMentions: [],
          forwardingScore: 999,
          isForwarded: true,
          forwardedNewsletterMessageInfo: {
            newsletterJid: "",
            newsletterName: "© 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 𝚅1 💚",
            serverMessageId: 999,
          },
          externalAdReply: {
            title: "© 𝙳𝙴𝚅 𝚂𝙷𝙰𝙳𝙾𝚆 𝙼𝙳 𝚅1 💚",
            body: " ©𝐌𝐑 𝐃𝐄𝐕 𝐒𝐇𝐀𝐃𝐎𝐖 💚",
            mediaType: 1,
            sourceUrl: "https://github.com/M",
            thumbnailUrl:
...
if (!app) return;
app.get("/", (req, res) => {
  res.send("hey dev shadow md est online✅");
});
app.listen(port, () =>
